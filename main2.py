...
def main():
    ...
    try:
        ...
        while number_of_cores != 0:
            ...
            thread = Thread(target=solve_function, args=(TEST_WORD, range_number[0], range_number[1], number_thread))
            number_thread += 1
